...
{
	protected internal virtual string GetCode() { return "CODE-1"; }
...
{
	protected internal override string GetCode() { return this.GetCurrentCode(); }
...
internal class DerivedClassB : DerivedClassA
{
	...
	protected internal override string GetCode() { return DerivedClassImpl.GetCode();}
...
public class Program
{
	...
	{		
		...
		VerifyModifiers();																																																	VerifyAccessibilityLevels(typeof(BaseClass), s2, typeof(DerivedClassA), s3, typeof(DerivedClassB));
	}
